...
function updateTimer() {
  const targetDate = new Date("january 9, 2026 22:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '543816651399'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '543816651399'; // Número para el primer botón
  const recipientNumber2 = '543815435964'; // Número para el segundo botón
